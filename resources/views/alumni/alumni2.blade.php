    ...
    <div class="main">
        ...
        <div class="px-2 py-3">
            ...
            <div class="container">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-1.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 70vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-2.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-3.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-4.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-5.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-6.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-7.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
                ...
                <div class="text-center align-items-center mb-3 pb-2">
                    <div class="row g-0 text-center align-items-center">
                        <img src="{{ asset('image/pdx14-8.jpeg') }}"
                            class="img-responsive text-center align-items-center" alt=""
                            style="width: 100%;
                            height: 60vw;
                            object-fit: cover;">
